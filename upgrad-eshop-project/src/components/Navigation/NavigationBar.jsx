...
export default function NavigationBar() {
  ...
  const dispatch = useDispatch();
  if(localStorage.getItem('anand.admin@upgrad.com') === null) {
    const adminDetails = {
      contactNumber: "+91887709962",
      email: "anand.admin@upgrad.com",
      firstName: "Anand",
      isAdmin: true,
      lastName: "Desai",
      password: "Admin@1234"
    };
    localStorage.setItem('anand.admin@upgrad.com', JSON.stringify(adminDetails));
  }
  return (
    <React.Fragment>
